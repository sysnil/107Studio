			 	...
			 	<table border="1" width="1000">
			 		 ...
			 		 <?php
							...
							while($row = mysqli_fetch_assoc($result)){
								...
								echo "<td> 
								<a href='delete_newscheck_common.php?id={$row['id']}'>删除</a>      
								<a href='change_news_common.php?id={$row['id']}'>编辑</a>
								<a href='istop_news.php?id={$row['id']}'>置顶</a>
								<a href='unstick_news.php?id={$row['id']}'>取消置顶</a>
								</td>";
								echo "</tr>";
							}
			 	...
			 	<table border="1" width="1200">
			 		 ...
			 		 <?php
							...
							while($row = mysqli_fetch_assoc($result)){
								...
								echo "<td>{$row['writer']}</td>";
								echo "<td> 
								<a href='delete_theorycheck_common.php?id={$row['id']}'>删除</a>      
								<a href='change_theory_common.php?id={$row['id']}'>编辑</a>
								<a href='istop_theory.php?id={$row['id']}'>置顶</a>
								<a href='unstick_theory.php?id={$row['id']}'>取消置顶</a>
								</td>";
								echo "</tr>";
							}
							//4、释放结果集，关闭数据库
