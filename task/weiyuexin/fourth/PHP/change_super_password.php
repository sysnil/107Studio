...
<html>
	...
	<body>
		<div class="login">
			...
			?>
			<div class="title">
				<h1 style="font-size: 22px;">更改超级管理员密码</h1>
			</div>
			<form action="change_super_passwordcheck.php" method="post">
				<div class="password">
						<input type="text" name="password1" placeholder="请输入原密码" id="username1">
				</div>
