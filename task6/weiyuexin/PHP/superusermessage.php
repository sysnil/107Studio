		...
		<div class="operation">
		 	 ...
		 	 <div class="content">
		 	 	<div class="manage">
		 	 		...
		 	 		<a href="backstage.php"><li>后台管理</li></a>
		 	 		<?php 
		 	 			echo "<a href='change_super_name.php?username=$username'><li>修改用户名</li></a>";
		 	 		?>
		 	 		<?php 
		 	 			echo "<a href='change_super_password.php?username=$username'><li>修改密码</li></a>";
		 	 		?>
