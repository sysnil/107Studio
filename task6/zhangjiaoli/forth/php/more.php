...
<body id="wrapper">
    <div id="wrap">
    	...
    	<div id="main">
            ...
            <div class="content">
            	<p class="position"><img src="../images/icon-index.png" width="30px"/><span>当前位置：<a href="index.html" target="_self">首页</a> ><a href="#">理论学习</a> ></span></p>
            	<ul>
            		<li><a href="javascript:void">京剧《双投唐》选段（西皮流水）</a></li>
            		<li><a href="javascript:void">贤弟把话错来讲</a></li>
            		<li><a href="javascript:void">细听愚兄说比方</a></li>
            		<li><a href="javascript:void">昔日里韩信谋家邦</a></li>
            		<li><a href="javascript:void">未央宫中一命亡</a></li>
            		<li><a href="javascript:void">毒死平帝是王莽</a></li>
            		<li><a href="javascript:void">千刀万剐无下场</a></li>
            	</ul>
            </div>
        </div>
        <div id="footer">
